      ...
      >
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          ...
          >
            ...
            >
              <div className="absolute inset-0 z-0 bg-gradient-to-b from-purple-200/80 to-pink-300/70"></div>
              ...
              <div
                className={`absolute inset-0 z-5 bg-center bg-contain bg-no-repeat transition-opacity duration-300 md:hidden ${
                  activeCardIndex > 0 ? "opacity-0" : "opacity-60"
                }`}
                style={{
                  backgroundImage:
                    "url('/lovable-uploads/9e5898fd-4ca5-4477-accf-89708ec49330.png')",
                }}
              ></div>
              ...
              <div
                className={`relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center md:justify-end transition-opacity duration-300 ${
                  activeCardIndex > 0 ? "opacity-0" : "opacity-100"
                }`}
              >
            ...
            >
              ...
              <div
                className={`absolute inset-0 z-5 bg-center bg-contain bg-no-repeat transition-opacity duration-300 md:hidden ${
                  activeCardIndex > 1 ? "opacity-0" : "opacity-50"
                }`}
                style={{
                  backgroundImage:
                    "url('/lovable-uploads/9e5898fd-4ca5-4477-accf-89708ec49330.png')",
            ...
            >
              ...
              {/* Mobile: Background image */}
              <div
                className="absolute inset-0 z-5 bg-center bg-contain bg-no-repeat opacity-50 md:hidden"
                style={{
                  backgroundImage:
                    "url('/lovable-uploads/9e5898fd-4ca5-4477-accf-89708ec49330.png')",
                }}
