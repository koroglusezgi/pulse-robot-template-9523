  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        ...
        description: "You'll receive updates about Kotodama AI soon."
      });
      setEmail("");
  ...
  return <section id="newsletter" className="bg-white py-0">
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-5xl font-display font-bold mb-4 text-left">Stay updated with Kotodama AI</h2>
          <p className="text-xl text-gray-700 mb-10 text-left">
            Get notified about new features, languages, and exclusive early access opportunities
          </p>
